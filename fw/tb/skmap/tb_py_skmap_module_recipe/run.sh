...
hdlworkflow nvc $TOP compile_order.txt --cocotb=test_skmap_module_recipe $@ --pythonpath=$SCRIPT_DIR -g BASE_ADDR=0 -g RAMFACE_ADDR_W=8 -g RAMFACE_DATA_W=32 -g RO_LEN=3 -g RO_VAL_W=12 -g RW_LEN=3 -g RW_VAL_W=12 -g FLAGK1=false -g FLAGK2=true
